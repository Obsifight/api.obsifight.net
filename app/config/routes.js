module.exports = {
    ...
    'get /user/:username/money': {'function': 'UserController.getMoney', protected: true},
    ...
    'get /socials/twitter/authorization/request': {
        'function': 'Socials/TwitterController.requestAuthorization',
        protected: false
    },
    'get /socials/twitter/authorization/response': {
        'function': 'Socials/TwitterController.requestResponse',
        protected: false
    },
    'get /socials/twitter/tweets/liked': {'function': 'Socials/TwitterController.getLikedTweets', protected: false}
}
